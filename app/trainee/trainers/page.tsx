...
} from "@/lib/competency/get-trainer-recommendations";
...
export default async function TrainerRecommendationsPage() {
  const {
    ...
    await getTrainerRecommendations();
    ...
    <main className="mx-auto max-w-6xl p-8">
      ...
      <div>
        ...
        <p className="mt-3 max-w-3xl text-gray-600">
          Trainer recommendations are
          calculated from your active
          competency gaps using verified
          expertise, experience, course
      ...
      {activeGaps.length === 0 && (
        <section className="mt-10 rounded-xl border p-6">
          ...
          <p className="mt-2 text-gray-600">
            All current competency targets
            are met. There are no active
            competency gaps requiring
            trainer support right now.
          </p>
        ...
        recommendations.length === 0 && (
          <section className="mt-10 rounded-xl border p-6">
            ...
            <p className="mt-2 text-gray-600">
              ...
              approved trainer has a
              verified competency match
              for your active development
              areas.
            </p>
          </section>
        )}
                  ...
                  >
                    ...
                    <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                      ...
                      <Metric
                        ...
                        value={`${primaryDriver.expertiseScore.toFixed(
                          0
                        )}/100`}
                      />
                      ...
                      <Metric
                        ...
                        value={`${primaryDriver.experienceScore.toFixed(
                          0
                        )}/100`}
                      />
                      ...
                      <Metric
                        ...
                        value={`${primaryDriver.relevanceScore.toFixed(
                          0
                        )}/100`}
                      />
                    ...
                    <p className="mt-4 text-xs text-gray-500">
                      ...
                      currently use neutral
                      baseline values until
                      sufficient verified
                      platform data is
                      available.
                    </p>
